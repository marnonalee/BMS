...
$pdf->AddPage();
$page = $pdf->setSourceFile(__DIR__."/../templates/INDIGENCY.pdf");
...
$pdf->Text(90, 118, $fullname);
$pdf->Text(147, 155, $purpose);
$pdf->Text(45, 176, $day);
$pdf->Text(75, 176, $month_year);

$saveDir = __DIR__ . "/../generated_certificates/";
if(!is_dir($saveDir)) mkdir($saveDir, 0777, true);
$filename = 'indigency_' . $id . '.pdf';
